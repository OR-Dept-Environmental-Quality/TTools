...
def update_nodes_fc1(NodeDict, streamID, nodeID, NodesFC, AddFields):
    """Updates a single node in the input point feature class with data
    from the nodes dictionary"""
...
def update_nodes_fc2(UpdateValue, nodeID, NodesFC, UpdateField):
